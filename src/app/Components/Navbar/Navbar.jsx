...
const Navbar = () => {
  ...
  return (
    <nav className="navbar bg-main sticky top-0 z-50 shadow-md min-h-16 lg:min-h-20 w-full max-w-full overflow-hidden">
        ...
        <div className="flex-1 min-w-0 overflow-hidden">
          ...
          >
            <Image
              ...
              width={50}
              height={50}
              className="w-8 sm:w-10 lg:w-12 h-auto flex-shrink-0 transition-transform duration-300"
            />
            <span className="truncate">Bottle Bouquets</span>
          </Link>
        </div>
